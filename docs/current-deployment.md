...
| --- | --- | --- | --- | --- |
| Production client | `endpoint-2.example.invalid` (`192.0.2.2`), `/etc/init.d/native-udp` | Local build of locked `742b89aa24` (Fast Open hotfix `c8ebb943bd` plus audit fixes `153de92c8e`, `afce211960`), OpenWrt x86_64 | `6e3a6655415b0f0e4481e1d524f906aa382d2314c5d96001afd7dfabc4b063b2` | SOCKS5 `127.0.0.1:1080`, `bbr1`, user `nativeudp` |
| Validation client | `endpoint-1.example.invalid`, `native-udp-client.service` | Same run, Linux x64 | `4b24c709396a03a299f7dc5784b56c6b598e535f84072599b11ae52d8bfb1dca` | SOCKS5 `127.0.0.1:1080`, `bbr1` |
| Production server | `endpoint-3.example.invalid`, `native-udp-caddy.service` | Product server run [`33743443764`](https://github.com/ssharkkky/naiveproxy/actions/runs/33743443764) | `52a1ca4f5cb2829c97af1a32359914baae7b93ca6548d8bb71a6291cc9860e3d` | TCP+UDP `:8443`, `bbr-standard` |
...
replacement. A rollback copy is stored under `/var/lib/proxy-private/`.
...
- Same source, Linux x64: `out/Release/naive`, SHA256
  ...
  `naive 150.0.7871.63`.
- Pre-deployment backup: `endpoint-2.example.invalid:/var/lib/proxy-private/
...
- `endpoint-2.example.invalid`: `/var/lib/proxy-private/native-udp.pre-F1F2-20260904-155351`
  (previous hotfix SHA256 `66035c78b788dc5e70f9bba112cdb1ddbdcc6765c406d21c7d5d5772e5a4a9fa`)
- `endpoint-1.example.invalid`:
  `/var/lib/proxy-private/naive.pre-standard-20260903-182150`
- `endpoint-3.example.invalid`:
  `/var/lib/proxy-private/caddy-naive-udp.pre-standard-20260903-102206`
