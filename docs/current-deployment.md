...
| --- | --- | --- |
| Router `192.0.2.2`, `/etc/init.d/native-udp` | `993bdf31785839f0041f1a82ed746f103925c43096daad3bd5fd5ca44f2e5f68` | SOCKS5 `127.0.0.1:1080`, `bbr1`, user `nativeudp` |
...
| Validation client `endpoint-1.example.invalid`, retained release `-3` | `31dddee0a07d89ddb865d0384beec1191fbdd968ac9b7651b14a4bdafb37253d` | Last verified before this deployment; outside replacement scope |
