...
| --- | --- | --- | --- | --- |
| Production client | `endpoint-2.example.invalid` (`192.0.2.2`), `/etc/init.d/native-udp` | Build run [`33708458095`](https://github.com/ssharkkky/naiveproxy/actions/runs/33708458095), OpenWrt x86_64 | `609bb34c492f29a1b158fcdc1e5a55957eda0d087b9ef9c51205214fd5a29e10` | SOCKS5 `127.0.0.1:1080`, `bbr1`, user `nativeudp` |
