...
| --- | --- | --- | --- | --- |
| Production client | `endpoint-2.example.invalid` (`192.0.2.2`), `/etc/init.d/native-udp` | Local hotfix `c8ebb943bd` (based on locked client), OpenWrt x86_64 | `66035c78b788dc5e70f9bba112cdb1ddbdcc6765c406d21c7d5d5772e5a4a9fa` | SOCKS5 `127.0.0.1:1080`, `bbr1`, user `nativeudp` |
