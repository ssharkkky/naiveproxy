...
- [`current-deployment.md`](current-deployment.md) is the authority for the
  binaries running on `endpoint-2.example.invalid`, `endpoint-1.example.invalid`, and
  `endpoint-3.example.invalid`. It links the client and server manifests, online
